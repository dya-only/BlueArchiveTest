...
function PickUp() {
  ...
  return (
    <div className="pick-up bg-cover font-molu-bold">
      ...
      <div className="flex justify-end items-center pr-8 w-screen h-screen text-[#383f46]">
        <div className="window-bg fixed z-20 w-[650px] h-[570px] bg-[#a9e0f5] rounded-md shadow-md">
